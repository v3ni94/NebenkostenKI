...
final class CategoryResolver
{
    ...
    private const array KEYWORDS = [
        ...
        'ENTWAESSERUNG' => ['entwaesserung', 'entwässerung', 'abwasser', 'schmutzwasser', 'kanalgebuehr'],
        ...
        'MUELLBESEITIGUNG' => ['muellbeseitigung', 'müllbeseitigung', 'muellgebuehr', 'abfallgebuehr', 'restmuell'],
