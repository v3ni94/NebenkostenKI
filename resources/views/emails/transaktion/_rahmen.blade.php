{{--
    Gemeinsamer Rahmen der Transaktionsmails aus app/Mail.
    ...
    liegt. Ein Logo wird nicht erfunden (Masterprompt 18).

    Keine Werbung, keine Superlative, kein Tracking und kein Zaehlpixel. Es gibt
    in dieser Vorlage bewusst kein einziges externes Bild.

    Tabellenlayout und Inline-Stile sind in E-Mails notwendig, weil viele
        ...
        <tr>
            <td align="center" style="padding:24px 12px;">
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
                    ...
                    @if ($punkte !== [])
                        <tr>
                            <td style="padding:0 32px 6px 32px; font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:1.6; color:#1a1a1a;">
                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                    @foreach ($punkte as $punkt)
                                        <tr>
                                            <td width="16" valign="top" style="padding:0 0 6px 0; color:#87888a;">&bull;</td>
                                            <td valign="top" style="padding:0 0 6px 0;">{{ $punkt }}</td>
                                        </tr>
                                    @endforeach
                                </table>
                            </td>
                    ...
                    <tr>
                        <td style="padding:24px 32px 28px 32px; font-family:Arial, Helvetica, sans-serif;">
                            ...
                            @if ($abmeldeUrl !== null)
                                <p style="margin:12px 0 0 0; font-size:12px; line-height:1.6; color:#87888a;">
                                    Sie erhalten diese Erinnerung, weil für Ihr Objekt noch eine Abrechnung offen ist.
                                    Erinnerungen abmelden:<br>
                                    <a href="{{ $abmeldeUrl }}" style="color:#87888a; word-break:break-all;">{{ $abmeldeUrl }}</a>
                                </p>
                                <p style="margin:8px 0 0 0; font-size:12px; line-height:1.6; color:#87888a;">
